...
import pt.uminho.ceb.biosystems.mew.core.simplification.model.nullspace.structure.interfaces.IModelStructureDouble;

public class MewEnvCondition implements IModifyModelParameter{

	public MewEnvCondition(HttpRequestWithBody o){
